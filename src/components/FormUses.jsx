...
const FormUses = ({CreateNewUser, updateInfo, updateUserById, setUpdateInfo, setCloseForm}) => {
    ...
    <form className='form' onSubmit={handleSubmit(submit)}>
      <div onClick={()=> setCloseForm(true)} className='form__x'>x</div>
         <h2 className='form__title'>{updateInfo ? 'update User' : 'Create User'}</h2>
            ...
            <div className='form__div'>
                <label  className='form__label' htmlFor="first_name">Firstname</label>
